...
<head>
    ...
    <title>Quên mật khẩu - Online Card Store</title>
            ...
            <div class="login-content">
                <div class="login-userset">
                    ...
                    <div class="login-userheading">
                        <h3>Quên mật khẩu</h3>
                        <h4>Nhập email để nhận link đặt lại mật khẩu</h4>
                    </div>
                    ...
                    <form action="${pageContext.request.contextPath}/auth/forgot-password" method="post" class="form-login-wrapper">
                        ...
                        <div class="form-login">
                            <button type="submit" class="btn btn-login">Gửi link đặt lại mật khẩu</button>
                        </div>
                    </form>

                    <div class="signinform text-center">
                        <h4><a href="${pageContext.request.contextPath}/login" class="hover-a">Quay lại đăng nhập</a></h4>
                    </div>
                </div>
            </div>
