...
<div class="card p-3 mb-3">
    <form method="get" action="${pageContext.request.contextPath}/admin/customer" class="row g-3">
        <div class="col-md-6">
        ...
        <c:if test="${not empty keyword || (not empty statusFilter && statusFilter != 'ALL')}">
            <div class="col-12">
                <a href="${pageContext.request.contextPath}/admin/customer" class="btn btn-secondary btn-sm">
        ...
        <c:when test="${empty customers}">
            <tr>
                <td colspan="6" class="text-center text-muted py-4">
                    <i class="fa fa-info-circle"></i> Không tìm thấy khách hàng nào
                </td>
            </tr>
        </c:when>
        <c:otherwise>
            <c:forEach var="c" items="${customers}">
                <tr>
                    ...
                    <td class="text-center">
                        <c:if test="${c.active}">
                            <a href="${pageContext.request.contextPath}/admin/customer/block?id=${c.id}&page=${currentPage}&keyword=${keyword}&status=${statusFilter}"
                        ...
                        <c:if test="${!c.active}">
                            <a href="${pageContext.request.contextPath}/admin/customer/unblock?id=${c.id}&page=${currentPage}&keyword=${keyword}&status=${statusFilter}"
...
<div class="d-flex justify-content-between align-items-center mt-3">
        ...
        <nav>
            <ul class="pagination mb-0">
                ...
                <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                    <a class="page-link" 
                       href="${pageContext.request.contextPath}/admin/customer?page=${currentPage - 1}&pageSize=${pageSize}&keyword=${keyword}&status=${statusFilter}">
                    ...
                    <c:when test="${totalPages > 0}">
                        <c:forEach var="i" begin="${currentPage > 3 ? currentPage - 2 : 1}" 
                            ...
                            <li class="page-item ${i == currentPage ? 'active' : ''}">
                                <a class="page-link" 
                                   href="${pageContext.request.contextPath}/admin/customer?page=${i}&pageSize=${pageSize}&keyword=${keyword}&status=${statusFilter}">
                                    ${i}
                                </a>
                            </li>
                        </c:forEach>
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <select class="form-select form-select-sm" style="width: auto;" 
                    onchange="window.location.href='${pageContext.request.contextPath}/admin/customer?page=1&pageSize=' + this.value + '&keyword=${keyword}&status=${statusFilter}'">
