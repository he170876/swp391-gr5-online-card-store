                ...
                <div class="login-userset">
                    ...
                    <c:if test="${not empty param.success}">
                        <div class="alert alert-success" role="alert">
                            <c:choose>
                                <c:when test="${param.success == 'register'}">Đăng ký thành công! Vui lòng đăng nhập.</c:when>
                                <c:when test="${param.success == 'reset'}">Đặt lại mật khẩu thành công! Vui lòng đăng nhập.</c:when>
                            </c:choose>
                        </div>
                    </c:if>
                    ...
                    <form action="${pageContext.request.contextPath}/login" method="post" class="form-login-wrapper">
                        ...
                        <div class="form-login">
                            ...
                            <div class="form-addons">
                                <input id="email" name="email" value="${email}" type="text" placeholder="Nhập địa chỉ email" value="${param.email}" required>
                        ...
                        <div class="form-login">
                            <div class="alreadyuser">
                                <h4><a href="${pageContext.request.contextPath}/auth/forgot-password" class="hover-a">Quên mật khẩu?</a></h4>
                            </div>
                        </div>
                    ...
                    <div class="signinform text-center">
                        <h4>Chưa có tài khoản? <a href="${pageContext.request.contextPath}/auth/register" class="hover-a">Đăng ký</a></h4>
                    </div>
                        ...
                        <ul>
                            <li>
                                <a href="${pageContext.request.contextPath}/oauth2/authorization/google">
                                    <img src="${pageContext.request.contextPath}/assets/img/icons/google.png" class="me-2" alt="google">
                                    Đăng ký bằng Google
                                </a>
                            </li>
                        </ul>
