...
<div class="container my-4">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-6 col-lg-2 d-flex gap-2">
                    ...
                    <a class="btn btn-outline-secondary w-100" href="${pageContext.request.contextPath}/products">Xóa lọc</a>
                </div>
            </div>
        </div>
    </form>
    ...
    <div class="d-flex justify-content-center align-items-center gap-2 mt-4">
        ...
        <a class="btn btn-outline-secondary ${currentPage == 1 ? 'disabled' : ''}"
           href="${pageContext.request.contextPath}/products?page=${prevPage}&keyword=${keyword}&categoryId=${categoryId}&providerId=${providerId}&priceRange=${priceRange}&stockStatus=${stockStatus}">
            Trước
        </a>
        <span>Trang ${currentPage} / ${totalPages}</span>
        <a class="btn btn-outline-secondary ${currentPage == totalPages ? 'disabled' : ''}"
           href="${pageContext.request.contextPath}/products?page=${nextPage}&keyword=${keyword}&categoryId=${categoryId}&providerId=${providerId}&priceRange=${priceRange}&stockStatus=${stockStatus}">
            Sau
        </a>
    </div>
</div>
