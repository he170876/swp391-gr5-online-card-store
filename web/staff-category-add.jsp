<%-- 
    Document   : staff-category-add
    Description: Add new category page for staff
--%>
...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        ...
        <h6>Tạo danh mục mới trong hệ thống</h6>
    </div>
...
<div class="card">
    <div class="card-body">
        <form action="${pageContext.request.contextPath}/staff/category/add" method="post" id="categoryForm">
