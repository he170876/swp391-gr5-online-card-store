<%-- 
    Document   : staff-product-add
    Description: Add new product page for staff
--%>
...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        ...
        <h6>Tạo sản phẩm mới trong hệ thống</h6>
    </div>
...
<div class="card">
    <div class="card-body">
        <form action="${pageContext.request.contextPath}/staff/product/add" method="post" id="productForm">
