<%-- 
    Document   : staff-provider-detail
    Description: Provider detail page for staff
--%>
...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        ...
        <h6>Xem thông tin chi tiết nhà cung cấp</h6>
    </div>
    <div>
        <a href="${pageContext.request.contextPath}/staff/provider/edit?id=${provider.id}" class="btn btn-primary me-2">
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body text-center">
                ...
                <p class="text-muted mb-3">Mã NCC: #${provider.id}</p>
                ...
                <div class="text-start">
                    ...
                    <c:choose>
                        <c:when test="${not empty provider.contactInfo}">
                            <p class="mb-0">${provider.contactInfo}</p>
                        </c:when>
                        <c:otherwise>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <span class="badge bg-primary fs-6">${provider.productCount}</span>
                </div>
                ...
                <c:choose>
                    <c:when test="${empty products}">
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted mb-0">Nhà cung cấp này chưa có sản phẩm nào</p>
                        </div>
                    </c:when>
                    <c:otherwise>
