<%-- 
    Document   : staff-provider-edit
    Description: Edit provider page for staff
--%>
...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        ...
        <h6>Cập nhật thông tin nhà cung cấp</h6>
    </div>
...
<div class="card">
    <div class="card-body">
        <form action="${pageContext.request.contextPath}/staff/provider/edit" method="post" id="providerForm">
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fa fa-save me-1"></i> Cập nhật nhà cung cấp
                </button>
            </div>
        </form>
    </div>
